      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 1.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          ...
          <div>
            ...
            <h2 style={{ fontFamily: "var(--font-mono, monospace)", fontSize: "clamp(1.7rem,3.5vw,2.8rem)", fontWeight: 700, letterSpacing: "-0.025em", lineHeight: 1.1, color: "#1a1333", marginBottom: "2.5rem", whiteSpace: "pre-line" }}>
              {heading}
            </h2>
          ...
          <div style={{ borderRadius: 24, background: "rgba(255,255,255,0.72)", border: "1px solid rgba(255,255,255,0.85)", backdropFilter: "blur(28px) saturate(200%)", boxShadow: "0 16px 56px rgba(99,88,210,0.18)", padding: "1.75rem", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ fontFamily: "var(--font-mono, monospace)", fontSize: "0.65rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "#9b92c0", marginBottom: "1.25rem" }}>{previewLabel}</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem", marginBottom: "1.25rem" }}>
              {stats.map((m, i) => (
                <div key={m.label} style={{ padding: "1rem", borderRadius: 14, background: "rgba(255,255,255,0.55)", border: "1px solid rgba(255,255,255,0.8)" }}>
                  <div style={{ fontFamily: "var(--font-mono, monospace)", fontSize: "1.4rem", fontWeight: 700, ...(i % 2 === 0 ? { background: "linear-gradient(135deg,#6c63ff,#a78bfa)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" } : { color: "#0ea5e9" }) }}>{m.val}</div>
