...
const D = CONTENT_DEFAULTS["booking.hero"] as Required<HeroProps>;

export default function BookingHeroPageSection({ eyebrow = D.eyebrow, heading = D.heading, headingAccent = D.headingAccent, paragraph = D.paragraph }: HeroProps) {
  return (
    <section style={{ paddingTop: 120, paddingBottom: "3rem", background: "linear-gradient(160deg,#f7f6fd,#eef0fb)", position: "relative", overflow: "hidden" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
        ...
        <h1 style={{ fontSize: "clamp(2rem,5vw,4rem)", fontWeight: 800, lineHeight: 1.05, letterSpacing: "-0.04em", color: "#1a1333", marginBottom: "1.25rem", maxWidth: 600 }}>
          {heading}{" "}
        ...
        <p style={{ fontSize: "1.1rem", color: "#5b5478", maxWidth: 480, lineHeight: 1.75 }}>{paragraph}</p>
      </div>
    </section>
  );
}
