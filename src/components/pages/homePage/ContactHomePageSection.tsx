...
export default function ContactHomePageSection() {
  ...
  const inputBase: React.CSSProperties = {
    ...
    border: "1.5px solid #E5E7EB", background: "#F8FFFE",
  ...
  const handleFocus = (e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    e.target.style.borderColor = "#0A5C68";
    e.target.style.boxShadow = "0 0 0 3px rgba(10,92,104,0.08)";
  };
  ...
  return (
    <section id="contact" style={{ background: "#F0FAF9", padding: "7rem 0", borderTop: "1px solid #E5E7EB" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "start" }}>
          ...
          <div>
            ...
            {[
              ...
              <div key={item.label} style={{ display: "flex", gap: "1.25rem", padding: "1.25rem", background: "#fff", borderRadius: 18, border: "1.5px solid #E5E7EB", marginBottom: "1rem", alignItems: "center" }}>
                <div style={{ width: 46, height: 46, minWidth: 46, borderRadius: 14, background: "rgba(10,92,104,0.07)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.3rem" }}>{item.icon}</div>
                <div>
          ...
          {/* Right: form */}
          <div style={{ background: "#fff", borderRadius: 28, padding: "2.75rem", border: "1.5px solid #E5E7EB", boxShadow: "0 16px 56px rgba(10,92,104,0.08)", position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 4, background: "linear-gradient(90deg, #0A5C68, #14b8a6)" }} />
            ...
            {sent ? (
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    width: "100%", padding: "1.05rem", background: form.name && form.email ? "#0A5C68" : "#CBD5E1",
                    color: "#fff", border: "none", borderRadius: 100, fontSize: "0.95rem", fontWeight: 700,
                    cursor: form.name && form.email ? "pointer" : "not-allowed",
                    boxShadow: form.name && form.email ? "0 8px 24px rgba(10,92,104,0.28)" : "none",
                  ...
                  onMouseLeave={e => {
                    (e.currentTarget as HTMLButtonElement).style.background = form.name && form.email ? "#0A5C68" : "#CBD5E1";
