      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: "6rem", alignItems: "start" }}>
          ...
          <div style={{ position: "sticky", top: "2rem" }}>
            ...
            <a href="#contact" style={{ fontSize: "0.9rem", fontWeight: 700, color: "#0A5C68", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "0.4rem", background: "rgba(10,92,104,0.07)", border: "1px solid rgba(10,92,104,0.14)", padding: "0.65rem 1.4rem", borderRadius: 100 }}>
              Ask us anything →
            </a>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column" as const, gap: "0.85rem" }}>
            {FAQS.map((faq, i) => (
              <div
                key={i}
                style={{ background: open === i ? "#F8FFFE" : "#fff", borderRadius: 18, border: `1.5px solid ${open === i ? "rgba(10,92,104,0.2)" : "#E5E7EB"}`, overflow: "hidden", transition: "all 0.3s ease", boxShadow: open === i ? "0 8px 32px rgba(10,92,104,0.08)" : "none" }}
              >
                <button
                ...
                >
                  ...
                  <span style={{
                    ...
                    background: open === i ? "#0A5C68" : "#F1F5F9",
                    border: "1px solid #E5E7EB",
                    display: "flex", alignItems: "center", justifyContent: "center",
                    fontSize: "0.7rem", color: open === i ? "#fff" : "#0A5C68",
