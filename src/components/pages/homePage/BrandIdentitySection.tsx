    ...
    <section id="brand" style={{ background: "#fbfaff", borderTop: "1px solid #f1effe", padding: "7rem 0" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "5rem" }}>
          ...
          <p data-strix-fade-up style={{ fontSize: "1.05rem", color: "#5b5478", maxWidth: 560, margin: "0 auto", lineHeight: 1.8 }}>
            {subheading}
          </p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem", marginBottom: "2rem" }}>
          <div style={{ background: "linear-gradient(165deg,#241c4d,#1a1333)", borderRadius: 24, padding: "3.5rem 3rem", display: "flex", flexDirection: "column" as const, alignItems: "center", gap: "2rem" }}>
          ...
          <div style={{ background: "#ffffff", borderRadius: 24, padding: "3.5rem 3rem", display: "flex", flexDirection: "column" as const, alignItems: "center", gap: "2rem", border: "1.5px solid #f1effe" }}>
            <div style={{ fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "#9b92c0", marginBottom: "-0.5rem" }}>Light Background</div>
            <div style={{ display: "flex", alignItems: "center", gap: "2.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.3fr", gap: "2rem", marginBottom: "2rem" }}>
          <div style={{ background: "#fff", borderRadius: 24, padding: "2.75rem", border: "1.5px solid #f1effe" }}>
            <div style={{ fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" as const, color: "#6c63ff", marginBottom: "1rem" }}>Abstract Logo</div>
            <h3 data-strix-slide-up style={{ fontSize: "1.3rem", fontWeight: 800, color: "#1a1333", marginBottom: "0.75rem", letterSpacing: "-0.025em" }}>Connected Intelligence</h3>
            <p style={{ fontSize: "0.9rem", color: "#5b5478", lineHeight: 1.8, marginBottom: "2rem" }}>
              {conceptParagraph1}
            </p>

            <div style={{ background: "linear-gradient(165deg,#241c4d,#1a1333)", borderRadius: 18, padding: "2rem", display: "flex", alignItems: "center", justifyContent: "center", gap: "3rem" }}>
              <StrixmindIcon size={72} theme="dark" />
              <StrixmindIcon size={56} theme="dark" />
              <StrixmindIcon size={40} theme="dark" />
            </div>
            <div style={{ textAlign: "center", fontSize: "0.7rem", color: "#9b92c0", marginTop: "0.75rem" }}>Logo at 72px, 56px, and 40px — consistent clarity at every size</div>
          </div>

          <div style={{ display: "flex", flexDirection: "column" as const, gap: "1.5rem" }}>
            <div style={{ background: "#fff", borderRadius: 24, padding: "2.25rem", border: "1.5px solid #f1effe", flex: 1 }}>
              <div style={{ fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" as const, color: "#6c63ff", marginBottom: "1rem" }}>Design Concept</div>
              <p style={{ fontSize: "0.9rem", color: "#5b5478", lineHeight: 1.85 }}>
                {conceptParagraph2}
              </p>
            </div>

            <div style={{ background: "#fff", borderRadius: 24, padding: "2.25rem", border: "1.5px solid #f1effe" }}>
              <div style={{ fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" as const, color: "#6c63ff", marginBottom: "1.25rem" }}>Brand Colours</div>
              <div style={{ display: "flex", gap: "1rem", marginBottom: "1.5rem" }}>
                {colors.map(c => (
                  <div key={c.hex} style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: "0.75rem", fontWeight: 700, color: "#1a1333", marginBottom: "0.15rem", fontFamily: "monospace" }}>{c.hex}</div>
                    <div style={{ fontSize: "0.68rem", fontWeight: 700, color: "#1a1333" }}>{c.name}</div>
                    <div style={{ fontSize: "0.62rem", color: "#5b5478" }}>{c.role}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* Attributes */}
        <div style={{ background: "linear-gradient(165deg,#241c4d,#1a1333)", borderRadius: 24, padding: "3rem", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "3rem", flexWrap: "wrap" as const }}>
              <div style={{ maxWidth: 320 }}>
                <div style={{ fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" as const, color: "#a78bfa", marginBottom: "1rem" }}>Conclusion</div>
