...
export default function BookingHeroPageSection({ eyebrow = D.eyebrow, heading = D.heading, headingAccent = D.headingAccent, paragraph = D.paragraph }: HeroProps) {
  return (
    <section style={{ paddingTop: 120, paddingBottom: "3rem", background: "var(--hero-bg)", position: "relative", overflow: "hidden" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
        ...
        <p style={{ fontSize: "1.1rem", color: "var(--text-muted)", maxWidth: 480, lineHeight: 1.75 }}>{paragraph}</p>
      </div>
    </section>
  );
}
