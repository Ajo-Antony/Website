...
export default function HeroHomePageSection() {
  ...
  return (
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", overflow: "hidden", background: "#051A1C" }}>
      {/* BG gradient mesh */}
      <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 80% 60% at 60% 40%, rgba(0,99,229,0.25) 0%, transparent 70%), radial-gradient(ellipse 40% 40% at 20% 80%, rgba(0,99,229,0.1) 0%, transparent 60%)", zIndex: 0 }} />
      {/* Grid overlay */}
      ...
      <div style={{ position: "absolute", bottom: 0, left: "50%", transform: "translateX(-50%)", width: "60%", height: "30%", background: "radial-gradient(ellipse at center, rgba(0,99,229,0.15) 0%, transparent 70%)", zIndex: 0 }} />
      ...
      <nav style={{ position: "relative", zIndex: 10, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1.5rem 3rem", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          <Link href="/booking" style={{ fontSize: "0.85rem", fontWeight: 600, color: "rgba(255,255,255,0.65)", textDecoration: "none", padding: "0.55rem 1.1rem" }}>Sign in</Link>
          <Link href="/booking" style={{ fontSize: "0.85rem", fontWeight: 700, color: "#fff", background: "#0063E5", textDecoration: "none", padding: "0.55rem 1.4rem", borderRadius: 100, border: "1px solid rgba(0,99,229,0.5)", boxShadow: "0 0 20px rgba(0,99,229,0.35)" }}>Start Free Trial</Link>
        </div>
      </nav>
      ...
      <div style={{ position: "relative", zIndex: 5, flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "4rem 2rem 6rem" }}>
        {/* Badge */}
        <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.06em", color: "#6aabff", background: "rgba(0,99,229,0.1)", border: "1px solid rgba(0,99,229,0.25)", padding: "0.35rem 1rem", borderRadius: 100, marginBottom: "2rem" }}>
          <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#0063E5", display: "inline-block" }} />
        ...
        <h1 style={{ fontSize: "clamp(3rem, 7vw, 5.5rem)", fontWeight: 800, color: "#fff", lineHeight: 1.05, letterSpacing: "-0.04em", marginBottom: "1.75rem", maxWidth: 860 }}>
          ...
          <span style={{ color: "#0063E5" }}>Scale Operations.</span><br />
          Grow Without Limits.
        </h1>

        <p style={{ fontSize: "1.15rem", color: "rgba(255,255,255,0.58)", lineHeight: 1.75, marginBottom: "2.5rem", maxWidth: 560 }}>
        ...
        <div style={{ display: "flex", gap: "1rem", alignItems: "center", marginBottom: "5rem", flexWrap: "wrap", justifyContent: "center" }}>
          <Link href="/booking" style={{ fontSize: "1rem", fontWeight: 700, color: "#fff", background: "#0063E5", padding: "0.95rem 2.5rem", borderRadius: 100, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "0.5rem", boxShadow: "0 0 40px rgba(0,99,229,0.45)" }}>
            Start Free Trial →
          </Link>
          <Link href="#demo" style={{ fontSize: "1rem", fontWeight: 600, color: "rgba(255,255,255,0.8)", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.14)", padding: "0.95rem 2.5rem", borderRadius: 100, textDecoration: "none" }}>
            Book a Demo
          </Link>
        </div>
        ...
        <div style={{ display: "flex", gap: "4rem", justifyContent: "center", flexWrap: "wrap" }}>
          {[
            ...
            <div key={i} style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: "0.8rem", color: "rgba(255,255,255,0.4)", marginTop: "0.35rem", fontWeight: 500 }}>{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Scroll hint */}
      <div style={{ position: "absolute", bottom: "2rem", right: "3rem", zIndex: 5, fontSize: "0.75rem", color: "rgba(255,255,255,0.3)", letterSpacing: "0.06em" }}>
        Scroll to explore ↓
      </div>
    </section>
  );
