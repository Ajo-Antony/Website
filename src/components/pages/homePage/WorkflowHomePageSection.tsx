...
export default function WorkflowHomePageSection({
  ...
  return (
    <section id="workflow" style={{ background: "var(--surface)", padding: "7rem 0", borderTop: "1px solid var(--divider)" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "5rem" }}>
          ...
          <p data-strix-fade-up style={{ fontSize: "1.1rem", color: "var(--text-muted)", maxWidth: 480, margin: "0 auto", lineHeight: 1.75 }}>
            {subheading}
          </p>
        </div>
        ...
        <div data-strix-stagger-grid style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "2rem", position: "relative" }}>
          ...
          <div
            ...
            style={{ position: "absolute", top: 44, left: "12.5%", right: "12.5%", height: 1, background: "linear-gradient(90deg, var(--accent), var(--border))", zIndex: 0 }}
          />
          ...
          {steps.map((step, i) => {
            ...
            <div key={step.title} data-strix-grid-item style={{ position: "relative", zIndex: 1 }}>
              <div
                ...
                style={{ width: 88, height: 88, borderRadius: "50%", background: i === 0 ? "linear-gradient(135deg,var(--accent),var(--accent-2))" : "#fff", border: `2px solid ${i === 0 ? "transparent" : "var(--border)"}`, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1.75rem", boxShadow: i === 0 ? "0 8px 32px var(--shadow-strong)" : "0 4px 20px var(--shadow)", transition: "all 0.35s ease" }}
              >
